...
\begin{document}
    ...
    \include{./01-elementos-pre-textuais/listaCodigos}      %lista de algoritimos
...
\begin{OnehalfSpacing}
    ...
    \include{./02-elementos-textuais/fundamentacao}           % Orientações
    \include{./02-elementos-textuais/trabalho}          % Apresentação
    \include{./02-elementos-textuais/consideracoes}
